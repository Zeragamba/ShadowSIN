...
export const addAllGear = (character: CharacterData): void => {
  ...
  addGear<WeaponData>(character, {
    ...
    addGear(character, { ...smartGunIntMod, id: '429f440e-ffc3-459d-b08f-b013af1648dc' }),
  ])
  ...
  addGear<WeaponData>(character, {
    ...
    addGear(character, { ...smartGunIntMod, id: '7c94f42b-e770-472f-85d8-992cde7e2606' }),
  ])
